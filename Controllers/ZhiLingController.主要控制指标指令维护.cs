...
namespace PlanExecut.Web.Areas.ZhiLingManage.Controllers {
	...
	public partial class ZhiLingController : Controller {
		...
		public ViewResult 主要控制指标指令维护() {
			return View("主要控制指标指令维护");
		}


		public ViewResult 主要控制指标指令_指令详情(string zhiLingId) {
			return View("主要控制指标指令维护.指令详情");
		}


		public ViewResult 主要控制指标指令_指令详情_保存(UserZhiLing one) {
